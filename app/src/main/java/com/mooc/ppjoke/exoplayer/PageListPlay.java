...
/**
 * 负责播放器的创建、切换和释放的播放器封装类（每个页面对应的共用播放控件）
 */
public class PageListPlay {
    public SimpleExoPlayer exoPlayer;//播放器实例
    public PlayerView playerView;//真实的展示视频画面的View
    public PlayerControlView controlView;//视频播放控制器
